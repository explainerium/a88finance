    ...
    <div className="space-y-8">
      ...
      {isAdmin && (
        <div className="grid gap-4 sm:grid-cols-2">
          <Link href="/admin/categories" className={`${card} flex items-center gap-3 hover:border-brand-gold`}>
          ...
          <Link href="/admin/tags" className={`${card} flex items-center gap-3 hover:border-brand-gold`}>
